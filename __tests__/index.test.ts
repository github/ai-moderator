...
const mockExtractFromEvent = extractFromEvent as jest.MockedFunction<typeof extractFromEvent>;
const mockShouldProcess = shouldProcess as jest.MockedFunction<typeof shouldProcess>;
const mockEvaluateContent = evaluateContent as jest.MockedFunction<typeof evaluateContent>;
const mockAddLabels = addLabels as jest.MockedFunction<typeof addLabels>;
const mockMinimizeComment = minimizeComment as jest.MockedFunction<typeof minimizeComment>;
...
describe('Main Function Integration', () => {
  beforeEach(() => {
    ...
    mockCore.getInput.mockImplementation((name: string) => {
      switch (name) {
        ...
        case 'openai-api-key': return 'fake-openai-key';
        case 'spam-label': return 'spam';
        case 'ai-label': return 'ai-generated';
        default: return '';
      }
    });
  ...
  it('should process spam content and apply labels', async () => {
    ...
    expect(mockMinimizeComment).toHaveBeenCalledWith(mockOctokit, 'issue-node-id');
  });
